...
<section class="myheader">
    <div class="container header_one">
        <div class="row">
            <div class="col-md-3">
                <a href="products?action="> <img src="image/4gear.png" height="100" width="160" class="img-fluid logo" alt="Logo"></a>
            </div>
            <div class="col-md-4 search-product">
                <div class="input-group input_text mb-3 py-3">
                    <form class="d-flex" action="products" method="get">
                        ...
                        <button class="btn btn-primary bg-danger" type="submit">Search</button>
                    </form>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 order-mb-1 gallery-product-template pd-right-0">
                    <div class="d-flex-wrap d-flex sticky-gallery">
                        <div class="product-gallery d-flex-slick slick-initialized slick-slider">
                            <img src="image/products/${product.getImage()}" alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pro-content-head clearfix">
                        <div class="head-product-title">
                            <h1 data-available="Còn hàng" class="green">
                                LAPTOP GAMING <c:out value="${product.getName()}" />
                            </h1>
                            <strong style="color: #b20a2c; font-size: 20px">Thông tin:  </strong>
                            <h2 style="font-size: 20px"> <c:out value="${product.getDescription()}"/></h2>
                        </div>
                    </div>
                ...
                <fmt:formatNumber type="number" value="${product.price}"/> VND
                            ...
                            <div class="action-buttons mt-3 d-flex justify-content-between">
                                ...
                                <button type="submit" name="action" value="add-to-cart" class="btn btn-danger">Thêm vào giỏ hàng</button>
                    ...
                    <div class="office">
                        <img src="image/products/tang_ban_quyen_office_2019.jpg" style="margin-bottom: 10px" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    function setOrderId(productId) {
        document.getElementById('orderIdInput').value = productId;
    }
</script>
