...
public class User {
    ...
    public User(int id, String account, String email, String name, String phone, String address, String role) {
        this.id = id;
        this.account = account;
        this.email = email;
        this.name = name;
    ...
    public User(String account, String email, String name, String phone, String address, String role) {
        this.account = account;
        this.email = email;
        this.name = name;
        this.phone = phone;
